                    ...
                    <div className="features-grid stagger-reveal">
                        ...
                        <div className="feature-card reveal">
                            <div className="feature-card-img">
                                <Image src="/images/range/range-bays.jpg" alt="Elevated hitting mats at Big Moose Driving Range" width={900} height={675} sizes="(max-width: 768px) 100vw, 50vw" />
                            </div>
                            <div className="feature-card-body">
                                <div className="feature-icon">
                                    <Image src="/images/icons/elevated-mats-icon.png" alt="" width={96} height={96} className="feature-card-icon-img" aria-hidden="true" />
                                </div>
                        ...
                        <div className="feature-card reveal">
                            <div className="feature-card-img">
                                <Image src="/images/range/range-targets.jpg" alt="Distance targets on the driving range" width={900} height={675} sizes="(max-width: 768px) 100vw, 50vw" />
                            </div>
                            <div className="feature-card-body">
                                <div className="feature-icon">
                                    <Image src="/images/icons/on-range-targets-icon.png" alt="" width={96} height={96} className="feature-card-icon-img" aria-hidden="true" />
                                </div>
                        ...
                        <div className="feature-card reveal">
                            <div className="feature-card-img">
                                <Image src="/images/range/yard-games-mini-golf.jpg" alt="Mini golf and yard games at Big Moose Driving Range" width={900} height={675} sizes="(max-width: 768px) 100vw, 50vw" />
                            </div>
                            <div className="feature-card-body">
                                <div className="feature-icon">
                                    <Image src="/images/icons/mini-golf-icon.png" alt="" width={96} height={96} className="feature-card-icon-img" aria-hidden="true" />
                                </div>
                        ...
                        <div className="feature-card reveal">
                            ...
                            <div className="feature-card-body">
                                <div className="feature-icon">
                                    <Image src="/images/icons/chipping-putting-icon.png" alt="" width={96} height={96} className="feature-card-icon-img" aria-hidden="true" />
                                </div>
                        ...
                        <div className="feature-card reveal">
                            ...
                            <div className="feature-card-body">
                                <div className="feature-icon">
                                    <Image src="/images/icons/yard-games-icon.png" alt="" width={96} height={96} className="feature-card-icon-img" aria-hidden="true" />
                                </div>
